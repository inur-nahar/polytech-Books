                        ...
                        <div class="payment">
                            ...
                            <div class="payment_option">
                                ...
                                <div class="online_payment_form">
                                    <input type="tel" class="form-control mb-3" name="payment_number" placeholder="Phone Number">
                                    <input type="text" class="form-control mb-3" name="txn_id" placeholder="TXN ID">
                                </div>
                            </div>
