                ...
                <div class="col">
                    <div class="footer-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp"
                        ...
                        <div class="logo mb-30">
                            <a href="index.html" class="mb-15"><img width="150" src="{{ asset('frontend/assets/img/ana.png') }}"
                                    alt="logo" /></a>
                            <p>Shop with us for a seamless online experience. Find quality Books at unbeatable
