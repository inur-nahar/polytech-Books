                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="border border-3 p-4 rounded">
                                <div class="mb-2">
                                    <label for="product_name" class="form-label">Book Title<span style="color: red;">*</span></label>
                                ...
                                <div class="mb-2">
                                    <label for="product_name" class="form-label">Book Slug</label>
                                ...
                                <div class=" mb-3">
                                    <div class="mt-2 col-sm-12" style=" border-radius:10px;">
                                        <label for="image" class="col-sm-12">Book Image<span
                        ...
                        <div class="col-lg-4">
                            <div class="border border-3 p-4 rounded">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        <label for="discount" class="form-label">Book Purchase Price<span
                                                style="color: red;">*</span></label>
                                    ...
                                    <div class="col-md-12">
                                        <label for="discount" class="form-label">Book discount<span
                                                style="color: red;">*</span></label>
                                    ...
                                    <div class="col-md-12">
                                        <label for="sku_name" class="form-label">Subject Code<span
                                                style="color: red;">*</span></label>
                                    ...
                                    <div class="col-md-12">
                                        <label for="product_tag" class="form-label">Book Tags<span
                                                style="color: red;">*</span></label>
